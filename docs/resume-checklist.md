...
- [ ] **Bullet points:** Paragraphs are avoided; bullet points are used for all descriptions.
- [ ] **No photo:** No photo is included (unless explicitly requested).
- [ ] **No unnecessary personal info:** Marital status, DOB, and other irrelevant personal details are omitted.

### FINAL CHECK
- [ ] **Read the entire resume:** You have read every word from top to bottom.
- [ ] **Exported as PDF:** The final file is in `.pdf` format (whether built in FlowCV, Docs, or LaTeX).
- [ ] **Filename is professional:** Saved with a proper name (e.g., `Firstname_Lastname_Resume.pdf`).
- [ ] **Test every link:** You have opened the final PDF and clicked every link to verify it works.
